<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Edit Kriteria Turnamen</h3>
            <p class="animated fadeInDown">
                Beranda <span class="fa-angle-right fa"></span> Kriteria <span class="fa-angle-right fa"></span> Edit Kriteria Turnamen
            </p>
        </div>
    </div>
</div>
    ...
    <div class="panel">
        <div class="panel-body">
            <div class="col-md-12 text-center">
                <h2>Edit Kriteria Turnamen</h2>
            </div>
            <div class="col-md-12" style="margin-top: 30px;;">
                <form action="<?= base_url('admin/c_kriteria/ac_update_kt_turnamen') ?>" method="post" onsubmit="return validate(this);">
                    <div class="col-md-12" style="margin-bottom: 20px;">
                        <label style="font-size: 20px;">Turnamen</label>
                        <div class="form-group">
                            <select class="fomr-text select2-turnamen" name="id_turnamen" required style="width: 50%;" readonly>
                            ...
                            <div class="col-sm-10">
                                ...
                                foreach ($non_gk as $val) : ?>
                                    <div class="col-md-4">
                                        ...
                                        <input type="checkbox" name="kt-non[]" value="<?= $val->id_kriteria ?>" id="non-<?= $i ?>" onclick="set_non('<?= $i ?>');" <?php foreach ($terpilih as $isi) {
                                                                                                                                                                        if ($val->id_kriteria == $isi->id_kriteria) {
                                                                                                                                                                            echo 'checked';
                                                                                                                                                                        }
                                                                                                                                                                    } ?>> <label for="non-<?= $i ?>"> <?= $val->nama_kriteria ?></label>
                                    </div>
                                <?php $i++;
                                endforeach; ?>
                            </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                foreach ($gk as $val) : ?>
                                    <div class="col-md-4">
                                        ...
                                        <input type="checkbox" name="kt-gk[]" value="<?= $val->id_kriteria ?>" id="gk-<?= $i ?>" onclick="set_gk('<?= $i ?>');" <?php foreach ($terpilih as $isi) {
                                                                                                                                                                    if ($val->id_kriteria == $isi->id_kriteria) {
                                                                                                                                                                        echo 'checked';
                                                                                                                                                                    }
                                                                                                                                                                } ?>> <label for="gk-<?= $i ?>"> <?= $val->nama_kriteria ?></label>
                                    </div>
                                <?php $i++;
                                endforeach; ?>
                            </div>
