<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Edit Detail Pertandingan</h3>
            <p class="animated fadeInDown">
                Beranda <span class="fa-angle-right fa"></span> Edit Detail Pertandingan
            </p>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12 tabs-area">
            ...
            <div class="tab-content tab-content-v5">
                <div class="tab-pane fade in active" id="tabs-demo6-area1">
                    ...
                    <div class="col-md-12">
                        <form action="<?= base_url('admin/c_pertandingan/ac_update_statistik') ?>" method="post" onsubmit="return confirm('Simpan Data Pertandingan?');">
                            <input type="hidden" name="id_pertandingan" value="<?= $detail[0]->id_pertandingan ?>" required>
                            <!-- NON-GK     -->
                                                ...
                                                <tr>
                                                    ...
                                                    <?php foreach ($kriteria_non as $kt) : ?>
                                                        <th style="text-align: center;">
                                                            <input type="hidden" name="id_detail[]" value="<?php foreach ($detail as $dt) {
                                                                                                                if ($a->id_pemain == $dt->id_pemain && $kt->id_kriteria_turnamen == $dt->id_kriteria_turnamen) {
                                                                                                                    echo $dt->id_detail_pertandingan;
                                                                                                                }
                                                                                                            } ?>" readonly required>
